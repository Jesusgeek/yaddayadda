...
//   constructor() { this._id = BaseElement.count++; }
//   get      id() { return 'el-'+this._id }

//   //TMP
//   get      a() { return 'el-'+this._id }
//   events = []
//   typ = "but00"
//   // props = [
//   //   ['t', 0, 'int', 'Top'],
...
//       .reduce((a, b) => { a[b]=this[b]; return a; },{});
...
const TYPES = {
  but00: {name:'Button',     props: {
                                l:new Prop("Left","int"), 
                                t:new Prop("Top","int"),
                                w:new Prop("Width","int"),
                                h:new Prop("Height","int")},},
  num00: {name:'Numeric',    props: {l:new Prop("Left","int"), t:new Prop("Top","int"),w:new Prop("Width","int"),h:new Prop("Height","int")},},
  //num00: {name:'Numeric',    props: {l:["Left","int"],t:["Top","int"],w:["Width","int"],h:["Height","int"]},},

};

TYPES.install = function (Vue) {
  Vue.prototype.$UI    = (key) => { return TYPES[key]; }; // <- not yet used
  Vue.prototype.$PROPS = (key) => { return TYPES.hasOwnProperty(key) ? TYPES[key].props : {}};
};
