<template>
  <div style="width:400px; height:500px; border:1px dashed #ccc;">
    <!-- <Grid
      ref="grid"
      :data-items="gridData"
      :edit-field="'inEdit'"
    ...
    <fabric-canvas>
      <fabric-circle :id="3" :hasRotatingPoint="false" @mouseup="dragTo"/>
    </fabric-canvas>
  </div>
</template>
...
export default {
  ...
  methods: {
    dragTo(eventData) {
      ...
      console.log(
        "top:" + eventData.target.top + " left:" + eventData.target.left
      );
      //console.log("x:" + eventData.transform.ex + " y:" + eventData.transform.ey);
    },
